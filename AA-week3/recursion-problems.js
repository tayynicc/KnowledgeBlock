...
// ***********************************************************************/
// take in array of nums and returns calue of all nums added together
// may be a mix of positive and negitive numbers

// base case
  // if the array is empty

// recursive step
  // array dot slice at 1 to remove the first element

// recursive function first ele + function name (altered array )

// name param
// base case
  // if !arr.length
// init num as arr.slice(1)
// returb num + fucniton name (array )

// const sumArray = (arr) => {
//   if(!arr.length)return 0;
//   // insted of storing the poped off ele in variable its taking it off in the recurslive call
...
// take in arr of flavors as well as users fav
// determine if the fav is avaliable

// base case
  //if the array is empty return false

// recursive step
  // remove ele of the arra

// call
  // call same conditionals on mutated arr

// name param
// remove ele from array store in variable
// conditions
// if ele .includes in array return true
// if not call frunction again on mutated arr until base case is met

// const iceCreamShop = (flavors, favorite) => {
//   if(!flavors.length) return false;
//   let ele = flavors.pop()
//   if(ele === favorite) return true;
...
// takes start and end returns arr of all nums in that range exculsive
// if end num is less that start return empty array
// make res defalut param
...
// call
  // function name passing in start end and now mutated res arr
